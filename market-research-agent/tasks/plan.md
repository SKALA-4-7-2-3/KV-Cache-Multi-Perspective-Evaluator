...
> 최신 설계: **2026-09-22 JSON 라이브 실행의 v1.2 원인 분석·수정안 작성 완료, 구현 대기.** [상세 설계](../docs/MARKET_JSON_RELIABILITY_DESIGN.md)와 [작업 목록 J1~J8](todo.md)을 따른다. 아래 v1.0/v1.1 완료 기록은 당시 검증 범위의 이력이다.
...
## JSON 라이브 실패 개선 v1.2 — 2026-09-22 설계 초안

[원인 분석 및 상세 수정 설계](../docs/MARKET_JSON_RELIABILITY_DESIGN.md)를 최신 제안으로 추가한다. 코드에는 아직 적용하지 않았다.
